...
class BrushVis {
    ...
    initVis() {
        ...
        vis.svg.append('g')
            ...
            .attr("id", 'brush-title')
            .append('text')
            .text('COVID Cases Selection Timeline')
    ...
    wrangleDataResponsive() {
        ...
        // rearrange data structure and group by state
        let dataByDate = Array.from(d3.group(vis.filteredData, d => d.submission_date), ([key, value]) => ({
            key,
            value
        }))
